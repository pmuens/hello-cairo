...
struct AmmState:
    # A dictionary that tracks the account's state.
...
struct AmmBatchOutput:
    # The balance of the AMM before applying the batch.
    member token_a_before : felt
    member token_b_before : felt
    # The balance of the AMM after applying the batch.
...
func hash_dict_values{pedersen_ptr : HashBuiltin*}(
    ...
    # Compute the ahsh of the account before and after the
    # change.
...
func get_account_dict() -> (account_dict : DictAccess*):
    ...
    %{
        ...
        # Save a copy of initial account dict for
...
func main{output_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
    ...
    %{
        ...
        # which will allow the verifier to chekc that they
        # are indeed valid.
    ...
    # Output the AMM's balances after apllyting the batch.
